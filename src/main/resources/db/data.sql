...
VALUES
    ...
    (4, 2, '이번 주에 본 영화에 대한 개인적인 생각입니다.<br>스포일러 없이 감상 포인트를 공유합니다.', 'POST', '2024-06-24'),
    (4, 2, '이번 주에 본 영화에 대한 개인적인 생각입니다.<br>스포일러 없이 감상 포인트를 공유합니다.', 'POST', '2024-06-24'),
    (4, 3, '더 나은 자신을 위한 자기개발 팁을 공유합니다.<br>모든 사람이 시도해 볼 수 있는 간단한 방법들입니다.', 'POST', '2024-06-24'),
    (4, 5, '집에서 쉽게 할 수 있는 가드닝 팁을 공유합니다.<br>집안을 더 아름답게 꾸밀 수 있는 방법을 알려드려요.', 'POST', '2024-06-25'),
