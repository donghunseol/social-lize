...
VALUES ('ssar@nate.com', '$2a$10$MXM315UryOr9MSS8FoEQLuCvxpxtXjg198i5N39QbaKodES42qUbi', '하승진',
        '/images/userprofile3.png', '010-1234-5678', '1994-12-26', 'USER', now(), null, 'NORMAL'),
       ('1@1.com', '$2a$10$MXM315UryOr9MSS8FoEQLuCvxpxtXjg198i5N39QbaKodES42qUbi', '김세운', '/images/userprofile3.png',
        '010-2345-6789', '1992-10-24', 'USER', now(), null, 'NORMAL'),
       ('jane@kakao.com', '$2a$10$MXM315UryOr9MSS8FoEQLuCvxpxtXjg198i5N39QbaKodES42qUbi', '박제인',
        '/images/userprofile.jpeg', '010-3456-7890', '1995-07-19', 'USER', now(), 'KAKAO', 'NORMAL'),
       ('john@naver.com', '$2a$10$MXM315UryOr9MSS8FoEQLuCvxpxtXjg198i5N39QbaKodES42qUbi', '설조온',
        '/images/userprofile.jpeg', '010-4567-8901', '1993-03-15', 'USER', now(), 'NAVER', 'NORMAL'),
       ('lucy@gmail.com', '$2a$10$MXM315UryOr9MSS8FoEQLuCvxpxtXjg198i5N39QbaKodES42qUbi', '김루씨',
        '/images/userprofile.jpeg', '010-5678-1234', '1996-08-30', 'USER', now(), null, 'NORMAL'),
       ('manager@gmail.com', '$2a$10$MXM315UryOr9MSS8FoEQLuCvxpxtXjg198i5N39QbaKodES42qUbi', '소셜 매니저',
        '/images/userprofile.jpeg', null, null, 'MANAGER', now(), null, 'NORMAL');
...
VALUES (1, 1, '이 커뮤니티에 오신 것을 환영합니다.<br>감사합니다.', 'POST', 'ACTIVE', now()),
       ...
       (1, 1, '저렴하게 여행할 수 있는 팁을 공유합니다.<br>비용을 절약하면서 여행의 즐거움을 누려보세요.', 'POST', 'DELETED', now()),
       (5, 4, '건강을 유지하는 데 필요한 헬스케어 정보를 공유합니다.<br>건강한 생활을 위한 팁을 알려드립니다.', 'POST', 'ACTIVE', now());

-- 소셜 마다 공지사항 등록
INSERT INTO board_tb (social_id, user_id, content, role, state, created_at)
VALUES (null, 6, '모든 회원은 서로를 존중해 주시기 바랍니다.<br>불쾌한 언행은 삼가해 주세요.', 'NOTICE', 'ACTIVE', now()),
...
-- 댓글 테이블
INSERT INTO reply_tb (board_id, user_id, comment, state, created_at)
VALUES (1, 1, '오늘도 좋은 하루 시작하셨나요? 활기찬 하루 되세요!', 'ACTIVE', now()),
       (2, 2, '이 포스트 정말 유익하네요. 더 많은 정보 기대할게요!', 'ACTIVE', now()),
       (3, 3, '동감합니다. 이 주제에 대해 더 깊이 있는 논의를 해보고 싶어요.', 'ACTIVE', now()),
       (4, 4, '안녕하세요, 여러분! 오늘의 토픽이 정말 흥미로워요.', 'ACTIVE', now()),
       (5, 5, '저도 경험해본 바로는 정말 그렇더라고요. 공감합니다.', 'ACTIVE', now()),
       (6, 1, '좋은 글 감사합니다. 다음 글도 기대됩니다!', 'ACTIVE', now()),
       (7, 2, '이 논점에 대해 조금 더 설명해 주실 수 있나요?', 'ACTIVE', now()),
       (8, 3, '오, 이건 정말 새로운 시각이네요. 생각해볼만한 주제입니다.', 'ACTIVE', now()),
       (9, 4, '제 생각과는 조금 다르네요. 하지만 인사이트는 좋습니다.', 'ACTIVE', now()),
       (10, 5, '이 정보 정말 도움이 되었어요. 공유해주셔서 감사합니다!', 'ACTIVE', now()),
       (11, 1, '이런 의견도 있군요. 저는 조금 다른 생각인데요...', 'ACTIVE', now()),
       (12, 2, '정말 흥미로운 점을 짚어주셨네요. 더 알아보고 싶어요.', 'ACTIVE', now()),
       (13, 3, '이 부분에 대한 더 많은 정보가 필요할 것 같습니다.', 'ACTIVE', now()),
       (14, 4, '글 잘 읽었습니다. 다음 내용도 기대하고 있겠습니다!', 'ACTIVE', now()),
       (15, 5, '여러분의 의견은 어떤가요? 저는 이렇게 생각해요.', 'ACTIVE', now()),
       (16, 1, '오늘 내용 정말 유용했습니다. 다들 어떻게 생각하시나요?', 'ACTIVE', now()),
       (17, 2, '사실 이 주제에 대해 더 공부해보고 싶어졌어요.', 'ACTIVE', now()),
       (18, 3, '이 주제에 대한 더 많은 논의가 필요한 듯 싶습니다.', 'ACTIVE', now()),
       (19, 4, '아주 좋은 글이었습니다. 작성자님께 감사드려요.', 'ACTIVE', now()),
       (1, 1, '삭제된 댓글입니다.', 'DELETE', now()),
       (2, 2, '삭제된 댓글입니다.', 'DELETE', now()),
       (3, 3, '삭제된 댓글입니다.', 'DELETE', now()),
       (4, 4, '삭제된 댓글입니다.', 'DELETE', now()),
       (5, 1, '삭제된 댓글입니다.', 'DELETE', now()),
       (6, 2, '삭제된 댓글입니다.', 'DELETE', now());

-- 대댓글 테이블
INSERT INTO rereply_tb (reply_id, user_id, comment, created_at)
VALUES (1, 1, '정말 좋은 의견 감사합니다!', now()),
...
VALUES (1, '카테고리 추가해주세요', '공포 카테고리 추가해주세요', '빠른 시일내로 추가해 드리겠습니다.', 'ANSWER', '2024-06-17', '2024-06-16'),
       (2, '대댓글에도 댓글을 달고 싶어요', '기능 추가 가능한가요?', '죄송합니다 대댓글에 댓글을 다는 기능은 추가해드리기 어렵습니다.', 'ANSWER', '2024-06-15',
        '2024-06-14'),
...
VALUES (1, 2, 21, null, null, '2번 유저가 1번 유저의 21번 게시글을 신고함', 'WAITING', now()),
       (2, 1, 22, null, null, '1번 유저가 2번 유저의 22번 게시글을 신고함', 'WAITING', now());
