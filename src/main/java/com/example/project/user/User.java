...
public class User {
    ...
    @Builder
    public User(Integer id, String email, String password, String nickname, String image, String phone, LocalDate birth, UserEnum role, UserProviderEnum provider, Long providerId, LocalDateTime createdAt) {
        this.id = id;
        this.email = email;
